							...
							<!-- Section -->
								<section>
									...
									<c:forEach items="${list}" var="board">
										<article>
											<a class="move image" href='<c:out value="${board.bno}"/>'><img src="/resources/images/YNEWS.png" alt="" /></a>
											<h3><a class="move" href='<c:out value="${board.bno}"/>'><c:out value="${fn:substring(board.title,0,30)}" />...</a></h3>
											<p><a class="move" href='<c:out value="${board.bno}"/>'> <c:out value="${fn:substring(board.content,0,50)}"/>...
											</a></p>
